...
function Bxe(t, n) {
  if (
    (1 & t &&
      (d(0, 'div', 32), ht(1, Lxe, 1, 3, 'app-st-message', 36, xxe), Xe(3, 'searchLogs'), u()),
    2 & t)
  ) {
    const e = g(2);
      ...
      this.ɵcmp = ut({
        ...
        template: function (i, o) {
          (1 & i &&
            ...
            u(),
            d(8, 'div', 5),
            H(9, Rxe, 7, 1, 'div')(10, Ixe, 4, 0, 'div', 6)(11, jxe, 21, 7, 'div', 7),
            u(),
