const ZAe = ['webcamContainer'],
  ePe = (t, n) => n.mediaValue.name,
  WB = (t, n) => n.value.appData.screenName,
  tPe = (t, n) => n.userID,
  nPe = (t, n) => ({ 'push-wrapper': t, 'mt-0': n }),
  qB = (t) => ({ 'btn-dark': t }),
  KB = (t) => ({ muted: t }),
  iPe = (t, n) => ({ 'breathing-rec': t, recIndicatorStart: n }),
  YB = (t) => ({ 'text-white': t }),
...
function rPe(t, n) {
  if ((1 & t && (d(0, 'p'), H(1, sPe, 2, 3, 'button', 32), u()), 2 & t)) {
    const e = g(2);
    (m(),
      O(
        1,
...
function mPe(t, n) {
  if (
    (1 & t && (d(0, 'li', 25)(1, 'a', 40), H(2, pPe, 1, 1, 'img', 41)(3, fPe, 3, 0), u()()), 2 & t)
  ) {
    const e = g(2);
    (m(),
...
function vPe(t, n) {
  if (1 & t) {
    ...
    (d(0, 'li', 26)(1, 'a', 43),
      ...
      v(10, 'Alert Logs'),
      u()(),
      H(11, _Pe, 4, 0, 'a', 49)(12, bPe, 4, 0, 'a', 46),
      u()());
  }
  if (2 & t) {
    const e = g(2);
...
function wPe(t, n) {
  ...
  if (2 & t) {
    ...
    (m(6),
      ...
      m(3),
      z('ngClass', ct(6, qB, i.isSortUsers)),
      m(4),
...
function TPe(t, n) {
  if (1 & t) {
    ...
    (d(0, 'div', 6)(1, 'div', 14)(2, 'nav', 15)(3, 'ul', 16, 2)(5, 'li', 17)(6, 'p'),
      ...
      v(11),
      u(),
      H(12, rPe, 2, 1, 'p')(13, aPe, 5, 2, 'p'),
      T(14, 'hr'),
      H(15, lPe, 3, 0, 'p')(16, cPe, 3, 0, 'p'),
      d(17, 'p'),
      H(18, dPe, 3, 0, 'span')(19, uPe, 3, 0, 'span'),
      u()(),
      d(20, 'li', 19)(21, 'a', 20),
      T(22, 'i', 21),
      d(23, 'span', 22),
      ...
      u()()(),
      H(31, mPe, 4, 2, 'li', 25)(32, vPe, 13, 3, 'li', 26),
      d(33, 'li', 25)(34, 'a', 27),
      x('click', function () {
      ...
      u()()(),
      H(43, yPe, 5, 0, 'li', 25)(44, wPe, 26, 8, 'li', 31),
      u()()()());
  }
  if (2 & t) {
    const e = g();
...
function NPe(t, n) {
  if (
    (1 & t &&
      ...
      v(3, ' \xa0 '),
      d(4, 'span', 145),
      ht(5, RPe, 2, 2, 'span', null, ePe),
      u(),
      v(7, ' \xa0 '),
      H(8, IPe, 1, 0, 'img', 146)(9, OPe, 1, 0),
      u()()),
    2 & t)
  ) {
    const e = g(2);
...
function ZPe(t, n) {
  if ((1 & t && (d(0, 'li'), H(1, XPe, 3, 1, 'a', 158)(2, JPe, 3, 1, 'a', 158), u()), 2 & t)) {
    const e = n.$implicit,
      i = g(4);
    (m(),
...
function t4e(t, n) {
  if (
    (1 & t &&
      ...
      u()(),
      H(5, VPe, 5, 0, 'div', 154)(6, YPe, 10, 5, 'ul', 155)(7, e4e, 5, 3),
      u()),
    2 & t)
  ) {
    const e = g(2);
    (m(),
      z('ngClass', ct(4, KB, !e.mediaService.isScreenSharing)),
      m(),
      z(
        'ngClass',
        Kn(
...
function i4e(t, n) {
  ...
  if (2 & t) {
    const e = g(2);
    (m(), z('ngClass', ct(2, YB, e.scPlaying)), m(4), O(5, e.scPlaying ? 5 : -1));
  }
}
function o4e(t, n) {
  if (1 & t) {
  ...
  if (2 & t) {
    const e = g(2);
    (m(), z('ngClass', ct(1, YB, e.scPlaying)));
  }
}
function s4e(t, n) {
  if (1 & t) {
...
function u4e(t, n) {
  if (1 & t) {
    ...
    (d(0, 'li', 99)(1, 'a', 182),
      ...
      u()(),
      H(13, a4e, 6, 0)(14, l4e, 5, 0)(15, c4e, 4, 0),
      ht(16, d4e, 3, 1, 'li', null, WB),
      Xe(18, 'keyvalue'),
      u()());
  }
  if (2 & t) {
...
function T4e(t, n) {
  ...
  if (2 & t) {
    ...
    (m(),
      ...
      z('ngClass', ct(12, KB, o.appService.globals.preferences.audioMutedFor[e.userID])),
      m(),
...
function D4e(t, n) {
  (1 & t && (ht(0, T4e, 7, 14, null, null, tPe), T(2, 'hr')),
...
function U4e(t, n) {
  if (1 & t) {
    ...
    (d(0, 'nav', 7),
      ...
      H(14, APe, 5, 2, 'li', 89)(15, PPe, 3, 2, 'li', 90)(16, NPe, 10, 1, 'li', 91)(
        17,
        LPe,
        3,
        0,
        'li',
        91
      )(18, BPe, 3, 0, 'li', 92)(19, UPe, 3, 1, 'li', 93)(20, jPe, 4, 0, 'li', 94)(
        21,
        t4e,
        8,
        9,
        'li',
        95
      )(22, i4e, 18, 4, 'li', 96)(23, o4e, 4, 3, 'li', 97)(24, s4e, 7, 4, 'li', 98)(
        25,
        r4e,
        3,
        0,
        'li',
        19
      )(26, u4e, 19, 9, 'li', 99)(27, h4e, 5, 4, 'li', 100)(28, p4e, 3, 0, 'li', 19)(
        29,
        f4e,
        5,
        0,
      ...
      H(33, g4e, 1, 0, 'i', 105)(34, _4e, 1, 0, 'i', 106)(35, b4e, 1, 0, 'i', 107),
      d(36, 'span', 108),
      v(37, 'Volume'),
      u()(),
      d(38, 'div', 109)(39, 'h4'),
      ...
      u(),
      T(44, 'br'),
      H(45, v4e, 2, 0, 'button', 113)(46, y4e, 2, 0),
      T(47, 'hr'),
      H(48, F4e, 5, 1, 'div', 114),
      T(49, 'div', 115),
      d(50, 'div', 116),
      H(51, D4e, 3, 0, 'hr'),
...
function K4e(t, n) {
  if (1 & t) {
    ...
    (d(0, 'as-split', 205),
      ...
      H(1, V4e, 7, 6, 'as-split-area', 206)(2, H4e, 4, 4, 'as-split-area', 207)(
        3,
        q4e,
        6,
        6,
...
function Z4e(t, n) {
  if (
    (1 & t &&
      ...
      H(1, Y4e, 7, 1, 'div', 213)(2, Q4e, 1, 0, 'app-positions-container'),
      T(3, 'app-presentationarea', 214),
      H(4, J4e, 3, 2, 'button', 215),
      u()),
    2 & t)
  ) {
    const e = g(2);
...
function nRe(t, n) {
  if (1 & t) {
    ...
    (d(0, 'as-split', 224),
      ...
      H(1, Z4e, 5, 5, 'as-split-area', 225)(2, eRe, 6, 3, 'as-split-area', 226)(
        3,
        tRe,
        4,
        4,
  ...
  class t {
    ...
    static {
      this.ɵfac = function (i) {
        return new (i || t)(be(Nt), be(ma), be(fa), be(__), be(fo), be(Ir), be(Xc), be(sa));
      };
    }
    static {
      this.ɵcmp = ut({
        ...
        template: function (i, o) {
          (1 & i &&
            (d(0, 'div', 4),
            H(1, oPe, 2, 0, 'ng-container'),
            d(2, 'div', 5),
            H(3, TPe, 45, 12, 'div', 6)(4, U4e, 93, 42, 'nav', 7)(5, K4e, 4, 7, 'as-split', 8)(
              6,
              nRe,
              4,
              6
