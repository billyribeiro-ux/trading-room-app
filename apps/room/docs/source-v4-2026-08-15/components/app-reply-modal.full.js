        ...
        bootbox.dialog({
          ...
          buttons: {
            success: {
              ...
              callback() {
                if (gc) {
                  const r = go('#msg-text-reply-upload').val().trim();
    ...
    onImagePaste(e) {
      ...
      if (s) {
        const r = URL.createObjectURL(s),
          a = go('#textAreaReplyTxt').val().trim();
        bootbox.confirm({
          message:
          ...
          callback: (l) =>
            I(function* () {
              if (l) {
                const c = yield go('#msg-text-reply').val().trim();
        ...
        template: function (i, o) {
          if (1 & i) {
            ...
            (d(0, 'div', 1)(1, 'div', 2)(2, 'div', 3)(3, 'div', 4)(4, 'h5', 5)(5, 'span', 6)(
              ...
              u(),
              d(10, 'div', 9),
              H(11, Hxe, 1, 0, 'ng-template', 10, 0, In),
