      ...
      this.ɵcmp = dt({
        ...
        template: function (i, o) {
          (1 & i &&
            ...
            v(5, 'Connectivity/Mic Troubleshooter'),
            u(),
            T(6, 'button', 6),
            u(),
            H(7, rAe, 6, 3, 'ul', 7),
            d(8, 'div', 8),
            H(9, wAe, 36, 57, 'div', 9)(10, jAe, 4, 3, 'div', 10),
            u(),
            H(11, $Ae, 10, 4, 'div', 11)(12, zAe, 3, 0, 'div', 11),
            u()()()),
            2 & i &&
              (m(7),
              O(7, o.appService.globals.isPresenter ? 7 : -1),
              m(2),
