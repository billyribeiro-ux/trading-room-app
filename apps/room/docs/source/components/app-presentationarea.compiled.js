  ...
  class t {
    ...
    newFile() {
      ...
      (o.addEventListener('dragover', vf, !1),
        ...
        o.addEventListener('drop', l0, !1),
        (o.style.display = 'block'),
        document.getElementById('fupload').addEventListener('change', l0, !1));
    }
    doFileListUpload() {
      var e = this;
      return I(function* () {
    ...
    static {
      this.ɵfac = function (i) {
        return new (i || t)(be(Nt), be(fo), be(ma), be(Ug), be(fa), be(Ir), be(g1), be(Tt));
      };
    }
    static {
      this.ɵcmp = dt({
        ...
        template: function (i, o) {
          (1 & i &&
            ...
            H(23, qCe, 8, 0, 'div', 15),
            u()()(),
            H(24, KCe, 7, 3, 'li', 16)(25, YCe, 7, 3, 'li', 16)(26, QCe, 7, 3, 'li', 16)(
              27,
              XCe,
              7,
              3,
            ...
            H(38, ZCe, 3, 4, 'div', 21)(39, TSe, 2, 1),
            u(),
            d(40, 'div', 22),
            H(41, DSe, 2, 0, 'h3', 23)(42, OSe, 7, 1),
            u(),
            d(43, 'div', 24),
            H(44, NSe, 5, 0, 'div')(45, $Se, 6, 0),
            u(),
            H(46, zSe, 3, 7, 'div', 25)(47, iwe, 3, 4, 'div', 26)(48, bwe, 11, 7, 'div', 27)(
              49,
              Rwe,
              11,
              7,
            ...
            T(80, 'i', 45),
            u(),
            H(81, Owe, 3, 0, 'button', 46),
            u(),
            d(82, 'div'),
            H(83, Nwe, 3, 0, 'button', 47),
            u()(),
            H(84, Lwe, 2, 0, 'h4', 48)(85, Qwe, 5, 3, 'table', 49),
            u()(),
            H(86, Xwe, 1, 2, 'app-ytplayer', 50)(87, Jwe, 1, 1, 'app-scplayer', 51),
            T(88, 'audio', 52),
            H(89, r2e, 9, 7, 'div', 53),
            u()),
            2 & i &&
              ...
              m(),
              z('ngClass', ut(46, Go, 'presAreaTabs-screens' == o.selectedMainTab)),
              m(6),
              z('hidden', o.hideStreams),
              m(),
              z('ngClass', ut(48, Go, 'presAreaTabs-streams' == o.selectedMainTab)),
              m(6),
              z('hidden', o.hideNotes),
              m(),
              z('ngClass', ut(50, Go, 'presAreaTabs-notes' == o.selectedMainTab)),
              m(6),
              ...
              m(),
              z('ngClass', ut(52, Go, 'presAreaTabs-files' == o.selectedMainTab)),
              m(6),
              O(35, o.isP ? 35 : -1),
              m(2),
              z(
                'ngClass',
                Kn(54, UCe, 'presAreaTabs-screens' == o.selectedMainTab, o.isFullScreenshare)
              ...
              m(2),
              z('ngClass', ut(59, Hr, 'presAreaTabs-notes' == o.selectedMainTab))(
                'hidden',
                o.hideNotes
              ),
              m(),
              ...
              m(),
              z('ngClass', ut(61, Hr, 'presAreaTabs-files' == o.selectedMainTab))(
                'hidden',
                o.hideFiles
              ),
              m(3),
              z('ngClass', ut(63, Go, 'files' === o.selectedFileTab)),
              m(4),
              Ze(o.filesTotal),
              m(2),
              z('ngClass', ut(65, Go, 'images' === o.selectedFileTab)),
              m(4),
              Ze(o.imagesTotal),
              m(2),
              z('ngClass', ut(67, Go, 'sounds' === o.selectedFileTab)),
              m(4),
              Ze(o.soundsTotal),
              m(4),
