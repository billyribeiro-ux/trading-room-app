...
function ZDe(t, n) {
  ...
  if (2 & t) {
    const e = n.$implicit,
      i = g(2);
    (z('ngClass', ut(5, WDe, i.currUser === e.uid)),
      m(2),
      z('ngClass', ut(7, qDe, e.online)),
      m(2),
...
function tEe(t, n) {
  if (
    (1 & t &&
      (d(0, 'div', 20), ht(1, ZDe, 8, 9, 'button', 39, HDe), H(3, eEe, 5, 0, 'div', 40), u()),
    2 & t)
  ) {
    const e = g();
...
function aEe(t, n) {
  if (1 & t) {
    ...
    (d(0, 'span', 65, 2),
      ...
      v(3, 'GIF'),
      u(),
      H(4, rEe, 18, 1, 'ng-template', null, 3, Rn),
      u());
  }
...
function lEe(t, n) {
  if (1 & t) {
    ...
    (d(0, 'div', 50)(1, 'div', 52),
      ...
      T(7, 'i', 58),
      u(),
      H(8, oEe, 2, 0, 'span', 59)(9, aEe, 6, 1, 'span', 60),
      u()()());
  }
  if (2 & t) {
    g();
...
function cEe(t, n) {
  if (
    (1 & t &&
      ...
      H(2, nEe, 1, 0, 'ng-template', 49, 1, Rn)(4, lEe, 10, 4, 'div', 50),
      u()),
    2 & t)
  ) {
    const e = g();
...
function hEe(t, n) {
  if ((1 & t && (d(0, 'div', 78), H(1, dEe, 1, 0)(2, uEe, 1, 0), u()), 2 & t)) {
    const e = g();
...
function PB(t) {
  (Mo('#fileList').show(), Mo('#filedrag').hide(), M2(t));
  var n = t.target.files || t.dataTransfer.files;
  (Mo('#fileList').empty(), (mc = []));
  for (var i, e = 0; (i = n[e]); e++) (mc.push(i), pEe(i));
}
