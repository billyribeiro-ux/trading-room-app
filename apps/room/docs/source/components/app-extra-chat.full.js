const x3e = ['chatWidthExtra'],
  M3e = ['searchTermTxt'],
  A3e = (t, n) => n.name,
  P3e = (t, n) => n.title,
  R3e = (t) => ({ 'chat-uploaded-img-sm': t }),
  I3e = (t) => ({ active: t }),
  R2 = (t) => ({ visible: t });
function O3e(t, n) {
...
function B3e(t, n) {
  if ((1 & t && (d(0, 'span', 28), v(1), H(2, L3e, 2, 1, 'span', 29), u()), 2 & t)) {
    const e = g().$implicit,
      i = g(2);
    (m(),
...
function U3e(t, n) {
  ...
  if (2 & t) {
    const e = n.$implicit,
      i = g(2);
    (m(),
      z('ngClass', ut(3, I3e, e.name == i.channel)),
      m(),
      Ne('', e.displayName, ' '),
      m(),
...
function j3e(t, n) {
  if ((1 & t && (d(0, 'ul', 12), ht(1, U3e, 4, 5, 'li', 14, A3e), u()), 2 & t)) {
    const e = g();
    (m(), pt(e.chatTabs));
  }
}
...
function z3e(t, n) {
  ...
  if (2 & t) {
    const e = g(3);
    (m(6),
      z('ngClass', ut(3, R2, 'g' == e.appService.globals.sessData.chatMode)),
      m(4),
      z('ngClass', ut(5, R2, 'p' == e.appService.globals.sessData.chatMode)),
      m(4),
      z('ngClass', ut(7, R2, 'd' == e.appService.globals.sessData.chatMode)));
  }
}
function G3e(t, n) {
  if (1 & t) {
...
function tMe(t, n) {
  if (1 & t) {
    ...
    (d(0, 'span', 72, 4),
      ...
      v(3, 'GIF'),
      u(),
      H(4, eMe, 18, 1, 'ng-template', null, 5, Rn),
      u());
  }
...
function iMe(t, n) {
  if (1 & t) {
    ...
    (d(0, 'span', 66),
      ...
      T(1, 'i', 67),
      u(),
      H(2, X3e, 2, 0, 'span', 63)(3, J3e, 2, 0, 'span', 68)(4, tMe, 6, 1, 'span', 69)(
        5,
        nMe,
        2,
        0,
...
function zB(t) {
  ...
  for (var i, e = 0; (i = n[e]); e++) (vc.push(i), aMe(i));
}
lMe = (() => {
  class t {
    constructor(e, i, o, s) {
    ...
    static {
      this.ɵcmp = dt({
        ...
        template: function (i, o) {
          if (1 & i) {
            ...
            (d(0, 'div', 6)(1, 'div', 7)(2, 'nav', 8)(3, 'a', 9),
              T(4, 'i', 10),
              H(5, O3e, 2, 0, 'span')(6, N3e, 3, 0, 'span', 11),
              u(),
              H(7, j3e, 3, 0, 'ul', 12),
              d(8, 'ul', 13),
              H(9, V3e, 3, 0, 'li', 14),
              ...
              T(15, 'i', 20),
              u()()()(),
              H(16, W3e, 11, 3, 'div', 21),
              u(),
              T(17, 'app-extra-roomscroller', 22, 0),
              H(19, q3e, 1, 0, 'ng-template', 23, 1, Rn)(21, K3e, 5, 0, 'div', 24)(
                22,
                Y3e,
                8,
                2,
        ...
        dependencies: [Di, qs, ai, Ss, ti, Ws, Yn, as, tc, ha, el, l6, k3e, os],
        styles: [
