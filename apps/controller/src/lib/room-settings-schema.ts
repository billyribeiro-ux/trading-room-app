...
// nothing in the room reads it yet. 120 of 269 are wired today.
...
export const ROOM_SETTINGS: readonly RoomSettingDef[] = [
  ...
  { name: "alertsOverlayOnScreenshare", section: "settings", type: "checkbox", label: "Alerts over screenshare?", help: "If enabled, alerts will appear over the screenshare in recordings", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  { name: "copyTrades", section: "settings", type: "checkbox", label: "Copy Trades?", help: "If enabled, users can copy trades by clicking on them", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "hasTypingIndicator", section: "settings", type: "checkbox", label: "Show typing indicator ?", help: "Show if somebody is typing in the room or PM", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "altChatRender", section: "settings", type: "checkbox", label: "Alt Chat Render?", help: "If enabled, renders chat sans avatars, and compact mode", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "enableDiscord", section: "settings", type: "checkbox", label: "Enable Discord?", help: "It will enable Discord", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "enableQAReactions", section: "settings", type: "checkbox", label: "Enable QA Reactions?", help: "If enabled, Users will be able to add reactions to the QA messages", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "isNewIndicatorOn", section: "settings", type: "checkbox", label: "Is New Room?", help: null, helpShape: null, helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "positionsIframeUrl", section: "settings", type: "textarea", label: "Positions Iframe Url", help: null, helpShape: null, helpOutside: false, captured: null, capturedIsDisplayOnly: false, group: null, wired: true },
  { name: "positionsIframe", section: "settings", type: "checkbox", label: "Enable positions iframe?", help: null, helpShape: null, helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "recordChat", section: "settings", type: "checkbox", label: "Record alerts and chat?", help: null, helpShape: null, helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "recsInRoom", section: "settings", type: "checkbox", label: "Show Recordings tab in the room?", help: "If enabled, will show recordings tab in the room", helpShape: "plain", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: true },
  ...
  { name: "clusterID", section: "settings", type: "text", label: "ClusterID", help: null, helpShape: null, helpOutside: false, captured: null, capturedIsDisplayOnly: false, group: "dont-touch", wired: true },
  { name: "backupClusterID", section: "settings", type: "text", label: "Backup ClusterID", help: "(In case the main clusterID is down, this is the backup, soft reset required for changes to take effect)", helpShape: "muted", helpOutside: false, captured: null, capturedIsDisplayOnly: false, group: "dont-touch", wired: true },
  ...
  { name: "linkedRoomAlerts", section: "settings", type: "textarea", label: "Linked Rooms for alerts", help: "Comma (,) separated list of Room IDs of the rooms to PUSH our alerts to", helpShape: "muted", helpOutside: false, captured: null, capturedIsDisplayOnly: false, group: "dont-touch", wired: true },
