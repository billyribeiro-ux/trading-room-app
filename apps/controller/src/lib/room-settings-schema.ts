...
export const ROOM_SETTINGS: readonly RoomSettingDef[] = [
  ...
  { name: "disableCopy", section: "settings", type: "checkbox", label: "Disable Copy?", help: "If enabled, it will disable right-click to prevent selecting and copying all text", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: false },
  ...
  { name: "hideNotes", section: "settings", type: "checkbox", label: "Hide Notes Section?", help: "If enabled, the room will not have the notes tab", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: false },
  ...
  { name: "darkThemeAsDefault", section: "settings", type: "checkbox", label: "Set Dark Theme As Default?", help: "If enabled, dark theme will be set as default", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: false },
  ...
  { name: "hideWebcamForRoom", section: "settings", type: "checkbox", label: "Hide WebCam in the room?", help: "If enabled, WebCam will be hidden in the room", helpShape: "muted", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: null, wired: false },
  ...
  { name: "hidePoweredBy", section: "settings", type: "checkbox", label: "Hide Powered By", help: "For pushing alerts and streams to other rooms, you can use the following settings. You need the other rooms ID and the API Secret of the other room to do this.", helpShape: "text", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: "dont-touch", wired: true },
  ...
  { name: "streamingThreads", section: "settings", type: "checkbox", label: "Streaming Threads?", help: "×", helpShape: "text", helpOutside: false, captured: false, capturedIsDisplayOnly: false, group: "dont-touch", wired: false },
