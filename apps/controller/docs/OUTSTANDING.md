...
**Honest limit:** only 33 of 269 settings have a consumer in the room today. The rest are stored
and inert until one lands. "Enabled" in this seed does not mean "working", and the module says so.
