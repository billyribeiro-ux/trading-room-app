...
**Honest limit:** 105 of 269 settings have a consumer in the room today (measured 2026-08-30;
this line read **33** for months while the real count tripled underneath it, and it is now checked by
`scripts/verify-room-settings-schema.mjs`). The remaining 164 are stored and inert until a
