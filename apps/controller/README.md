...
**120 of 269 settings are wired**, measured 2026-09-03 and checked on every run by
...
149 entries remain `wired: false`: the controller can store them, but the room does
