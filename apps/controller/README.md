...
**106 of 269 settings are wired**, measured 2026-08-30 and checked on every run by
...
163 entries remain `wired: false`: the controller can store them, but the room does
