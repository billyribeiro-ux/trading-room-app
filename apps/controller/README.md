...
**113 of 269 settings are wired**, measured 2026-09-02 and checked on every run by
...
156 entries remain `wired: false`: the controller can store them, but the room does
