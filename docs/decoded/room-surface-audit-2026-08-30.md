...
**Forty-two rows have been appended since this document was committed**, and none of them is
...
**Fourteen of the forty-two are the two surfaces added on 2026-08-31** — `MainTabStrip.svelte`
