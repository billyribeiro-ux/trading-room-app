...
| 5 | **Nine dead controls** remain inert, gated by `user-action-disposition-contract.test.ts` with a reason each. The gate stops a tenth appearing; it does not build the nine | the captured wire for each |
