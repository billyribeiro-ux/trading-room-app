...
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P   | **PR #20 MERGED 2026-08-14 15:11 EDT on the owner's instruction; PR [#21](https://github.com/billyribeiro-ux/trading-room-app/pull/21) is open with the eight commits since.** #20 was merged on the green from its FINAL push — head `db79ee6`, verified check-by-check on that exact SHA (Rust and PostgreSQL security contracts SUCCESS, `mergeState: CLEAN`) rather than on a rollup that might have been stale, and merging was kept a separate act from pushing. #21 carries the extra chat column, its mention routing and `hideChat` collapse, the visibility-change work, and three rows closed by evidence; the full gate was run against that branch too — `pnpm -r test` **exit 0**, room 1075/91, controller 937/90, zero failures. **Standing instruction unchanged for #21 — push freely, merge only on the green from its final push.** | LOW — bookkeeping | this row |
...
| S   | **The room-side login page — the owner wants the original matched exactly. BLOCKED on a settings-boundary conflict found 2026-08-14 14:5x, not on effort.** The flow is confirmed: Launch is `/session?id={{sess.uuid}}&jwtSite={{tokSite}}` (`page.manageSession.html:11`, `page.welcome.html:379`); `jwtSite` is nowhere in the room bundle, so `/session` is the MAIN site's route; the room then ALWAYS renders `app-session-login` and **nothing auto-submits** — `doLoginCheck()` has exactly four callers, all click/submit bindings (`:408,451,908,948`). Ours redirects straight in, which is the divergence reported. **THE BLOCKER: none of the seven settings that DRIVE that page reach the room.** Checked against `ROOM_VISIBLE_SETTINGS`, all zero: `showPasswordField`, `usernameInstructions`, `hasRequiredPhoneInLogin`, `disableEditingUsername`, `customEnterDisclosure`, `webinarPW`, `banIPList`. Building the page now would render every feature permanently off — dead scaffolding. **Five of them can be added** by the usual four edits; they are not credential-shaped. **Two CANNOT: `webinarPW` and `banIPList` match the `credentialShaped` regex that `room-config-boundary.test.ts` asserts no room-visible setting may match** (`PW$` and an explicit `banIPList`). Upstream's room holds the room password in the BROWSER because its room and site are one system; ours deliberately refuses to send it. So the room password and IP ban list cannot be checked in the room the way the reference checks them — the equivalent is the room's SERVER asking the controller, which is a design decision with no counterpart in the capture. **Also corrected here:** an earlier draft of this work compared the submitted password to `webinarPW`. That was INVENTED — `loginToRoom()` sends `i.pw` and never compares it; the reference's server decides, and that server is not in the capture. A password is REQUIRED only when `authMode == 'pw'` AND no token was passed, so on the launch path it is never demanded. | **owner decision on the two credential settings; the other five are mechanical** | this row |
