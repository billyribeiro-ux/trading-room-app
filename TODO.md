...
| # | open item | needs |
| --- | --- | --- |
| 1 | **`askQuestion` has no mute gate of either kind** (`alert-questions.remote.ts:56`). Whether a CHAT mute should silence Q&A has no evidence either way in anything read | a capture script (`~/CLAUDE.md` §3) |
