...
| 14 | `lib/components/ScreenPane.svelte` | 789 | `## ScreenPane.svelte` in the v4 register — Seven rows, read end to end on 2026-08-31 against the same pinned bundle, with |
...
**93 of 93 surfaces audited · 40,161 of 40,161 lines · 100.0%.**
