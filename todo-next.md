...
| 4 | `lib/components/AlertChatArea.svelte` | 1542 | no |
...
| 13 | `routes/session/+page.svelte` | 710 | §17.8 — 18 divergences, 11 gaps, 6 defects. **Audited at 659 lines; it is now 701.** Changed twice since (`3b4f3c5`, `b73c337`), so the audit covers a superseded revision. |
...
**80 of 93 surfaces audited · 28,908 of 39,366 lines · 73.4%.**
