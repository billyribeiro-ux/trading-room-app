...
|---:|---|---:|---|
| 1 | `lib/components/ModalHost.svelte` | 6,887 | no |
...
| 8 | `lib/components/RoomOverlays.svelte` | 1,138 | `## RoomOverlays.svelte` in the v4 register — 7 gaps, read 2026-08-31. |
...
| 24 | `lib/components/AlertQaModal.svelte` | 393 | §19.4, §19.3 — 10 items, 6 defects, 1 false comment, against the reference's 159-line `<app-alert-qa-modal>`. Plus §QAM, 13 rows from a whole re-read on 2026-08-31: 4 built, 2 fixed, 1 already built, 1 measured refusal, 4 blocked. |
...
**38 of 83 surfaces audited · 15,096 of 36,455 lines · 41.4%.**
