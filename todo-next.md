...
|---:|---|---:|---|
| 1 | `lib/components/ModalHost.svelte` | 6,280 | no |
| 2 | `lib/components/notes/NoteEditor.svelte` | 1,696 | no |
| 3 | `routes/+page.svelte` | 1,542 | no |
...
| 8 | `lib/components/RoomOverlays.svelte` | 954 | no |
...
**2 of 70 surfaces audited · 1,072 of 32,742 lines · 3.3%.**
